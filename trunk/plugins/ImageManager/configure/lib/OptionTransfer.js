...
//  passed in. Currently-selected options will not be changed.b
// -------------------------------------------------------------------
...
function OT_copyLeft() { copySelectedOptions(this.right,this.left,this.autoSort); this.update(); }
function OT_copyRight() { copySelectedOptions(this.left,this.right,this.autoSort); this.update(); }
...
function OT_removeLeft(){ removeSelectedOptions(this.left); this.update();}
function OT_removeRight(){ removeSelectedOptions(this.right); this.update();}
...
function OptionTransfer(l,r) {
	...
	this.copyLeft=OT_copyLeft;
	this.copyRight=OT_copyRight;
	this.removeLeft=OT_removeLeft;
	this.removeRight=OT_removeRight;
