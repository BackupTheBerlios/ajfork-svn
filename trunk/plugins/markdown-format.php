...
Plugin URI:		http://daringfireball.net/projects/markdown/dingus
Description:	<a href="http://daringfireball.net/projects/markdown/syntax">Markdown syntax</a> allows you to write using an easy-to-read, easy-to-write plain text format. Based on the original Perl version by <a href="http://daringfireball.net/">John Gruber</a>.
Version:		1.0
Author:			Michel Fortin
Author URI:		http://www.michelf.com/
*/

$GLOBALS['fs_formats']['Markdown'] = 'Markdown';

if (isset($GLOBALS['fs_formats']['SmartyPants'])) {
	$GLOBALS['fs_formats']['Markdown + SmartyPants'] = 'fs_MarkdownAndSmartyPants';

	if (!function_exists('fs_MarkdownAndSmartyPants')) {
...
if (strcasecmp(substr(__FILE__, -16), "classTextile.php") == 0) {
	...
	@include_once 'smartypants-format.php';
...
#	$tags_to_skip = "!<(/?)(?:pre|code|kbd|script|math)[\s>]!";
	...
	foreach ($tokens as $null => $cur_token) {
		if ($cur_token[0] == 'tag') {
