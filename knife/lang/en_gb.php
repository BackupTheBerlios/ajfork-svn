...
$lang->templates_fillnew		= 'New templates will be based on the one selected above. Enter the new name below:';
$lang->templates_newtemplate	= 'Add new template';
$lang->templates_editname		= 'Change template name';
